...
# Reclassify ####
# Winter
x1 <- data.snowlines_climate$`2017`$winter_snowfall_mean
...
# Summer
x2 <- data.snowlines_climate$`2017`$summer_snowfall_mean
...
# Autumn
x3 <- data.snowlines_climate$`2017`$autumn_snowfall_mean
...
# Spring
x4 <- data.snowlines_climate$`2017`$spring_snowfall_mean
...
# Open SVG ####
svg(filename = paste0("~/snowlines/outputs/snowline climate/plots/snowline climate plot snowfall.svg"),
...
browseURL(url = "~/snowlines/outputs/snowline climate/plots/snowline climate plot snowfall.svg")