...
# Testing for normality on only the rsla column
# Open PDF
pdf("~/snowlines/outputs/snowline rsla/normality/rsla normality.pdf")

# Get Data
y_data <- data.snowlines_rsla$rsla
x_data <- data.snowlines_rsla$aqcuisition_time_median
title <- "rsla"
