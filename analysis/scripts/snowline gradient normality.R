...
# Testing for normality on only the gradient column
# Open PDF
pdf("~/snowlines/outputs/snowline gradient/normality/gradient normality.pdf")

# Get Data
y_data <- data.snowlines_gradients$gradient
x_data <- data.snowlines_gradients$aqcuisition_time_median
title <- "gradient"
