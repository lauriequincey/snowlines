...
function.plot_seasons <- function(data_x, data_y, err, mdl, point_shape, colour_adjustment) {
  ...
  arrows(x0 = data_x,
         ...
         angle = 90,
         code = 3,
         col = function.col_adjust(aes.colour$transluscent_blue1, colour_adjustment),
         lty = "solid",
...
browseURL(url = "~/snowlines/outputs/climate space/plots/climate space plot snowfall.png")
